...
Args=parseArgs(varargin,Args,{'Holdaxis'},{'Spacing' {'sh','sv'}; 'Padding' {'pl','pr','pt','pb'}; 'Margin' {'ml','mr','mt','mb'}; 'Parent' {'p'} });
...
if Args.Holdaxis
    ...
    if Args.Parent
        h=subplot('position',[xpos1 1-ypos2 xpos2-xpos1 ypos2-ypos1], 'Parent',Args.Parent);
    else
